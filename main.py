...
print("solar system {} has maximum planets {} out of all the solar system planets that we have discovered so far...!".format(max_solar_system,solar_system_planet_count[max_solar_system]))
